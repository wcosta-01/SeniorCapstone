...
from file_dir import get_gaze_coords, video_dir, east_text_det
...
def wit_video(rt_data):

    pytesseract.pytesseract.tesseract_cmd = "C:\\Program Files\\Tesseract-OCR\\tesseract.exe"

    toCheck = get_gaze_coords(1920, 1020) # I just imported get_gaze_coords from wit
    ...
    while True:
        ...
        cv2.rectangle(orig, (int(newBound[0]), int(newBound[1])), (int(newBound[2]), int(newBound[3])), (255, 255, 0), 2)
        ...
        for (startX, startY, endX, endY) in boxes:
            ...
            if (newBound[0] < endX and newBound[2] > startX and newBound[1] < endY and newBound[3] > startY):
                ...
                print(text)
        # rW = 3.125, rH = 1.75625
        # x = int((-65.8343650936389 + (1920/2)) / oRW)
        # print(x)
        # y = int((-11.8607818305806 + (1080/2)) / oRH)
        # print(y)
        # newBound = [(x - 50), (y - 50), (x + 50), (y + 50)]
        # print(newBound)
